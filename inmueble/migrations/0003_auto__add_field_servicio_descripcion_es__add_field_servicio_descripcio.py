...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Servicio.descripcion_es'
        db.add_column(u'inmueble_servicio', 'descripcion_es',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Servicio.descripcion_en'
        db.add_column(u'inmueble_servicio', 'descripcion_en',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Inmueble.descripcion_es'
        db.add_column(u'inmueble_inmueble', 'descripcion_es',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Inmueble.descripcion_en'
        db.add_column(u'inmueble_inmueble', 'descripcion_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Comodidad.descripcion_es'
        db.add_column(u'inmueble_comodidad', 'descripcion_es',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Comodidad.descripcion_en'
        db.add_column(u'inmueble_comodidad', 'descripcion_en',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Servicio.descripcion_es'
        db.delete_column(u'inmueble_servicio', 'descripcion_es')

        # Deleting field 'Servicio.descripcion_en'
        db.delete_column(u'inmueble_servicio', 'descripcion_en')

        # Deleting field 'Inmueble.descripcion_es'
        db.delete_column(u'inmueble_inmueble', 'descripcion_es')

        # Deleting field 'Inmueble.descripcion_en'
        db.delete_column(u'inmueble_inmueble', 'descripcion_en')

        # Deleting field 'Comodidad.descripcion_es'
        db.delete_column(u'inmueble_comodidad', 'descripcion_es')

        # Deleting field 'Comodidad.descripcion_en'
        db.delete_column(u'inmueble_comodidad', 'descripcion_en')
    ...
    models = {
        ...
        u'inmueble.inmueble': {
            ...
            'fecha_ingreso': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 1, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
