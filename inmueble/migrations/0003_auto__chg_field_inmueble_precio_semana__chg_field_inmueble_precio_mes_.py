...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inmueble_inmueble', 'precio_semana', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

        # Changing field 'Inmueble.precio_mes'
        db.alter_column(u'inmueble_inmueble', 'precio_mes', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

        # Changing field 'Inmueble.precio_dia'
        db.alter_column(u'inmueble_inmueble', 'precio_dia', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))
