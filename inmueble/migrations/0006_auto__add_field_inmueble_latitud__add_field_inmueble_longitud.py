...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inmueble.latitud'
        db.add_column(u'inmueble_inmueble', 'latitud',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=13, decimal_places=8, blank=True),
                      keep_default=False)

        # Adding field 'Inmueble.longitud'
        db.add_column(u'inmueble_inmueble', 'longitud',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=13, decimal_places=8, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inmueble.latitud'
        db.delete_column(u'inmueble_inmueble', 'latitud')

        # Deleting field 'Inmueble.longitud'
        db.delete_column(u'inmueble_inmueble', 'longitud')
    ...
    models = {
        ...
        u'inmueble.inmueble': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitud': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '13', 'decimal_places': '8', 'blank': 'True'}),
            'longitud': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '13', 'decimal_places': '8', 'blank': 'True'}),
