...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'inmueble.inmueble': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'precio_dia': ('django.db.models.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            'precio_mes': ('django.db.models.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            'precio_semana': ('django.db.models.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
