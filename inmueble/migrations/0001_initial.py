...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inmueble_inmueble', (
            ...
            ('precio_dia', self.gf('django_prices.models.PriceField')(currency='USD', max_digits=8, decimal_places=2)),
            ('precio_semana', self.gf('django_prices.models.PriceField')(currency='USD', max_digits=8, decimal_places=2)),
            ('precio_mes', self.gf('django_prices.models.PriceField')(currency='USD', max_digits=8, decimal_places=2)),
    ...
    models = {
        ...
        u'inmueble.inmueble': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'precio_dia': ('django_prices.models.PriceField', [], {'currency': "'USD'", 'max_digits': '8', 'decimal_places': '2'}),
            'precio_mes': ('django_prices.models.PriceField', [], {'currency': "'USD'", 'max_digits': '8', 'decimal_places': '2'}),
            'precio_semana': ('django_prices.models.PriceField', [], {'currency': "'USD'", 'max_digits': '8', 'decimal_places': '2'}),
